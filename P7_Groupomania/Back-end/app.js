...
const {
    ...
    middleware: mysql_middleware
} = require('./install/mysql')
mysql_install()
...
app.use('/images/comment', express.static(path.join(__dirname, 'images/comment_images')));
